...
xi.settings.main =
{
    ...
    EXP_RATE        = 5.000, -- Multiplies exp from script (except FoV/GoV).
    CAPACITY_RATE   = 5.000, -- Multiplies capacy points gained.
    BOOK_EXP_RATE   = 5.000, -- Multiplies exp from FoV/GoV book pages.
    ...
    ENABLE_TRUST_ALTER_EGO_EXTRAVAGANZA          = 2, -- 0 = disabled, 1 = summer/ny, 2 = spring/autumn, 3 = both
    ...
    AQUAVEIL_COUNTER                = 4,     -- Base amount of hits Aquaveil absorbs to prevent spell interrupts. Retail is 1.
    ABSORB_SPELL_AMOUNT             = 25,     -- how much of a stat gets absorbed by DRK absorb spells - expected to be a multiple of 8.
    ABSORB_SPELL_TICK               = 10,     -- duration of 1 absorb spell tick
    ...
    ACTIVATE_LAMP_TIME   = 19000, -- Time in miliseconds for lamps to stay lit. TODO: Get retail confirmation.
    ...
    LANTERNS_STAY_LIT            = 2000,  -- time in seconds that lanterns in the Den of Rancor stay lit.
    ...
    REGIME_REWARD_THRESHOLD      = 25,    -- If the player is more than N levels below the minimum suggested range, do not award experience.
